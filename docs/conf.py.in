# -*- coding: utf-8 -*-
#
# galario documentation build configuration file, created by
...
copyright = '2017-%d, %s' % (datetime.now().year, authors)
...
version = str(galario.__version__)
# The full version, including alpha/beta/rc tags.
release = str(galario.__version__)
...
# documentation.
html_theme_options = {
    'githuburl': 'https://github.com/mtazzari/galario/',
