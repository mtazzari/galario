...
dreal _chi2_image(int nx, int ny, void* data, dreal v_origin, dreal dRA, dreal dDec, dreal duv, dreal PA, int nd, void* u, void* v, void* fobs_re, void* fobs_im, void* weights);
...
void _interpolate(int nx, int ncol, void *data, dreal v_origin, int nd, void *u, void *v, dreal duv, void *fint);
