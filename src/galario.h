...
#endif /* __cplusplus */
    /* Main user functions */
    void galario_sample(int nx, int ny, dreal* data, dreal dRA, dreal dDec, dreal du, int nd, dreal* u, dreal* v, dcomplex* fint);
    void galario_chi2(int nx, int ny, dreal* data, dreal dRA, dreal dDec, dreal du, int nd, dreal* u, dreal* v, dreal* fobs_re, dreal* fobs_im, dreal* weights, dreal* chi2);

    /* Interface for the experts */
    dcomplex* galario_fft2d(int nx, int ny, dreal* data);
