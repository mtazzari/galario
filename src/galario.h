...
#endif /* __cplusplus */
    /* Main user functions */
    void galario_sampleProfile(int nr, const dreal* f, dreal Rmin, dreal dR, dreal dxy, int nxy, dreal dist, dreal dRA, dreal dDec, dreal duv, int nd, const dreal* u, const dreal* v, dcomplex* fint);
